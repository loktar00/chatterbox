...
export CHATTERBOX_APPLY_WATERMARK="${CHATTERBOX_APPLY_WATERMARK:-1}"
export HF_HUB_DISABLE_PROGRESS_BARS="${HF_HUB_DISABLE_PROGRESS_BARS:-1}"
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-}"
export HIP_VISIBLE_DEVICES="${HIP_VISIBLE_DEVICES:-}"
export ROCR_VISIBLE_DEVICES="${ROCR_VISIBLE_DEVICES:-}"

exec /root/chatterbox/.venv/bin/python -m uvicorn chatterbox_api:app --host 0.0.0.0 --port "${PORT:-8000}"
