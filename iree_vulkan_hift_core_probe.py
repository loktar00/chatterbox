#!/usr/bin/env python3
"""IREE Vulkan probe for HiFT/HiFiGAN core without STFT/ISTFT."""
...
OUT_DIR = ROOT / "exports" / "iree_vulkan_hift_core"
...
class TinyHiFTCoreNoFft(nn.Module):
    """HiFT decode core taking source STFT directly and returning postnet channels."""
...
def main() -> None:
    ...
    try:
        ...
        model = TinyHiFTCoreNoFft().cpu().eval()
        ...
        source_stft_path = OUT_DIR / "source_stft.npy"
        ...
        cpu_export = aot.export(
            ...
            module_name="tiny_hift_core_no_fft",
            function_name="forward",
        )
        mlir_path = OUT_DIR / "tiny_hift_core_no_fft.mlir"
        cpu_export.save_mlir(mlir_path)
        result["mlir"] = mlir_path.as_posix()

        cpu_vmfb = OUT_DIR / "tiny_hift_core_no_fft_llvm_cpu.vmfb"
        ...
        vulkan_vmfb = OUT_DIR / "tiny_hift_core_no_fft_vulkan_gfx1013.vmfb"
    ...
    result_path = OUT_DIR / "tiny_hift_core_probe.json"
